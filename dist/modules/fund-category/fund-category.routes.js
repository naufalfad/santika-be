...
router.get('/balances', (0, rbac_guard_1.authorize)(client_1.Role.SUPER_ADMIN, client_1.Role.BENDAHARA, client_1.Role.PASTOR, client_1.Role.DEWAN_KEUANGAN), fund_category_controller_1.FundCategoryController.getFundBalances);
router.get('/', (0, rbac_guard_1.authorize)(client_1.Role.SUPER_ADMIN, client_1.Role.BENDAHARA, client_1.Role.PASTOR, client_1.Role.DEWAN_KEUANGAN), fund_category_controller_1.FundCategoryController.getFundCategories);
...
router.post('/transfer', (0, rbac_guard_1.authorize)(client_1.Role.BENDAHARA, client_1.Role.SUPER_ADMIN), (0, validation_middleware_1.validateRequest)(fund_category_schema_1.transferFundCategoryBalanceSchema), fund_category_controller_1.FundCategoryController.transferBalance);
