...
class ProfileController {
    ...
    static async updateAvatar(req, res, next) {
        try {
            ...
            const updatedUser = await profile_service_1.ProfileService.updateAvatar(userId, avatarUrl);
    ...
    static async updatePassword(req, res, next) {
        try {
            ...
            const result = await profile_service_1.ProfileService.updatePassword(userId, oldPassword, newPassword);
            return res.status(200).json({
                status: 'success',
